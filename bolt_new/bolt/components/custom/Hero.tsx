...
export default function Hero({}: Props) {
  ...
  if (!messagesContext) throw new Error("Hero must be used inside MessagesProvider");
  if (!userContext) throw new Error("Hero must be used inside UserDetailProvider");
